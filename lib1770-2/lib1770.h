...
#define LIB1770_CALLOC(n,size) calloc(n,size)
#define LIB1770_FREE(p) free(p)

#define LIB1770_MESSAGE(message) do {					       \
...
#define LIB1770_Q2DB(q) (20.0*log10(q))
#define LIB1770_DB2Q(db) (pow(10.0,0.05*(db)))

#define LIB1770_IS_DEN(x) (fabs(den_tmp=(x))<1.0e-15)
#define LIB1770_DEN(x) (LIB1770_IS_DEN(x)?0.0:den_tmp)

#define LIB1770_MIN(x,y) ((x)<(y)?(x):(y))

#define LIB1770_SILENCE (-70.0)
#define LIB1770_SILENCE_GATE (pow(10.0,0.1*(0.691+LIB1770_SILENCE)))
#define LIB1770_LUFS(x) (-0.691+10.0*log10(x))
...
void lib1770_biquad_get_ps(const lib1770_biquad_t *, lib1770_biquad_ps_t *);
lib1770_biquad_t *lib1770_biquad_requantize(lib1770_biquad_t *,
    const lib1770_biquad_t *);
...
int lib1770_stats_create(lib1770_stats_t *);
void lib1770_stats_destroy(lib1770_stats_t *);
#endif

lib1770_stats_t *lib1770_stats_new(void);
void lib1770_stats_close(lib1770_stats_t *);

#define LIB1770_STATS_MERGE_FIX
#if defined (LIB1770_STATS_MERGE_FIX) 
void lib1770_stats_merge(lib1770_stats_t *, const lib1770_stats_t *);
#else
void lib1770_stats_merge(lib1770_stats_t *, lib1770_stats_t *);
#endif
void lib1770_stats_add_sqs(lib1770_stats_t *, double);

double lib1770_stats_get_mean(lib1770_stats_t *, double);
double lib1770_stats_get_range(lib1770_stats_t *, double, double, double);
double lib1770_stats_get_max(lib1770_stats_t *);
...
lib1770_block_t *lib1770_block_new(double, double, int);
void lib1770_block_close(lib1770_block_t *);

void lib1770_block_add_stats(lib1770_block_t *, lib1770_stats_t *);
void lib1770_block_add_sqs(lib1770_block_t *, double);
...
#if defined (LIB1770_LFE) 
lib1770_pre_t *lib1770_pre_new_lfe(double, int, int);
lib1770_pre_t *lib1770_pre_new(double, int) LIB1770_DEPRECATED;
#else 
lib1770_pre_t *lib1770_pre_new(double, int);
#endif
void lib1770_pre_close(lib1770_pre_t *);

void lib1770_pre_add_block(lib1770_pre_t *, lib1770_block_t *);
void lib1770_pre_add_sample(lib1770_pre_t *, lib1770_sample_t);
void lib1770_pre_flush(lib1770_pre_t *);
